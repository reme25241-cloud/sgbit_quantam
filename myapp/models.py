...
class CustomUser(AbstractUser):
    ...
    # store keys as base64 strings (demo)
    kem_pk = models.TextField(blank=True, null=True)
    kem_sk = models.TextField(blank=True, null=True)
    sign_pk = models.TextField(blank=True, null=True)
    sign_sk = models.TextField(blank=True, null=True)
...
class Message(models.Model):
    ...
    encrypted_meta = models.JSONField(blank=True, null=True)
    ...
    def __str__(self):
        return f"{self.sender} → {self.receiver or 'Group'}"
